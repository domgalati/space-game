...
<tileset version="1.10" tiledversion="1.10.2" name="SpaceRoguelikeSpriteSheet3x-tilesize-24" tilewidth="24" tileheight="24" tilecount="851" columns="23">
 <image source="../Downloaded Packs/MAS Space Roguelike (v.1.0)/SpaceRoguelikeSpriteSheet3x-tilesize-24.png" width="552" height="888"/>
 <tile id="157">
  <animation>
