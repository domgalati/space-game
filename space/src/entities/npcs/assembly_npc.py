...
hobbies = [
    ...
    "Gardening", "Cooking", "Baking", "Knitting", "Crocheting",
    ...
    "Cycling", "Mountain Biking", "Scootering", "Roller Skating",
    "Ice Skating", "Horseback Riding", "Horseback Martial Arts", "Archery", "Frog Fencing",
    "Boxing", "Martial Arts", "Yoga", "Pilates", "Golfing",
    "Tennis", "Badminton", "Table Tennis", "Bowling",
    "Billiards", "Darts", "Chess", "Board Games", "Video Gaming",
    ...
    "Metal Detecting", "Treasure Hunting", "Traveling", "Language Learning",
    "History", "Genealogy", "Philosophy", "Astrology",
    "Tarot Reading", "Numerology", "Blogging", "Vlogging",
    "Podcasting", "Listening to Music", "Watching Movies", "Theater Going",
    "Attending Concerts", "Visiting Museums", "Collecting (Stamps, Coins, etc.)",
